...
//            $(".mark01_l").on("click",function(){
//                
//                var secLi = $(".mark01_i").children("li"),
//                    imgW = secLi.width();
//                
//                secLi.first().stop().animate({"margin-left":imgW},500,function(){
//                    secLi.css({marginLeft:0}).last().prependTo(".in_img");
//                });
//                
//            });
//                
//            $(".mark01_r").on("click",function(){
//                
//                var secLi = $(".mark01_i").children("li"),
//                    imgW = secLi.width();
//                
//                secLi.first().stop().animate({"margin-left":-imgW},500,function(){
//                    secLi.css({marginLeft:0}).first().prependTo(".in_img");
//                });
//                
//            });
//            
//            $(".mark02_l").on("click",function(){
//                
//                var secLi = $(".mark02_i").children("li"),
//                    imgW = secLi.width();
//                
//                secLi.first().stop().animate({"margin-left":imgW},500,function(){
//                    secLi.css({marginLeft:0}).last().prependTo(".in_img");
...
//            });
//                
//            $(".mark02_r").on("click",function(){
//                
//                var secLi = $(".mark02_i").children("li"),
//                    imgW = secLi.width();
//                
//                secLi.first().stop().animate({"margin-left":-imgW},500,function(){
//                    secLi.css({marginLeft:0}).first().appendTo(".in_img");
//                });
//                
//            });
//            
